...
public class MainController {
    ...
    private void playStartupAnimation() {
        Node[] elements = { logoBox, forgeTagline };
    ...
    // ── Navigation ────────────────────────────────────────────
    @FXML public void openHome()           { swapTo("/view/home.fxml"); }
    @FXML public void openPrograms()       { swapTo("/view/program_panel.fxml"); }
    @FXML public void openExercises()      { swapTo("/view/exercise_panel.fxml"); }
    @FXML public void openSessions()       { swapTo("/view/session_panel.fxml"); }
    @FXML public void openProgress()       { swapTo("/view/progress_panel.fxml"); }
    @FXML public void openHealthProfiles() { swapTo("/view/health_profile_panel.fxml"); }
    @FXML public void openGoals()          { swapTo("/view/goal_panel.fxml"); }
    @FXML public void openInjuries()       { swapTo("/view/injury_panel.fxml"); }
    @FXML public void openRehabPlans()     { swapTo("/view/rehab_plan_panel.fxml"); }
    @FXML public void openRehabTracking()  { swapTo("/view/rehab_tracking_panel.fxml"); }
    @FXML public void openTasks()          { swapTo("/view/task_panel.fxml"); }
    @FXML public void openNutrition()      { swapTo("/gui/main.fxml"); }
    ...
    // ── Login success animation (called from auth controllers) ─
    public void playLoginPushAnimation(Runnable onDone) {
        ...
        seq.getChildren().add(new ParallelTransition(
            ttImpact, stImpact, rtImpact, glowBurst, ftTitle, ftSub,
            new SequentialTransition(shake1, shake2, shake3)));
    ...
    private URL resolveResource(String path) {
        ...
        if (url == null) url = Thread.currentThread().getContextClassLoader()
